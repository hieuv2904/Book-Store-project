            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="row col-12">
                        <p>
                            <a href="./home.php">Trang chủ</a> &gt; <a href="./index.php?Category=<?php echo $categorical_page ;?>&page=1"><?php echo $category; ?></a> &gt; <a href="./detail_index.php?Category=<?php echo $categorical_page ;?>&id=<?php echo $id ;?>"><?php echo $name; ?></a>
                        </p>
                    </div>  
                    <div class="row col-12">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-7 summary">
                            ...
                            if (isset($_COOKIE['user_name']) && isset($_COOKIE['password'])) {
                                ...
                                //$link_addcart = "./detail_index.php?Category=" . $categorical_page . "&id=" . $id;
                                $link_buy = './tranggiohang.php';
                                $temp = 1;
                            } 
                            else {
                                $link_buy = './index_login.php';
                                $link_addcart = './index_login.php';
                                $temp = 0;
                            }   
                            ?>    
                            <div class="row">
                                <div class="col-6">
                                    <a href = '<?php echo $link_addcart; ?>'>

                                        <button class="btn btn-success add d-block w-100" type="button" onclick="addcart(<?php echo $temp ;?>, <?php echo $id_cat ;?>, <?php echo $id ;?>, '<?php echo $username ;?>')">
                                ...
                                <div class="col-6">
                                    <a href = '<?php echo $link_buy; ?>'>
                                        <button class="btn btn-success buy d-block w-100" type="button" onclick="addcart(<?php echo $temp ;?>, <?php echo $id_cat ;?>, <?php echo $id ;?>, '<?php echo $username ;?>')">
