                        ...
                        <div class="topcontent">
                                ...
                                <div class="search">
                                    <div class="style-search">
                                        <div class="insearch">
                                            ...
                                            <input type="text" placeholder="Bạn tìm gì hôm nay" class="text-search" value="">
                                            <button class="button">
                                                Tìm kiếm
                                            </button>
                                        </div>
                            ...
                            <div class="col-md-5">
                                <div class="icon">
                                    ...
                                    <div class="lienhe">
                                       <img src="./image/logo/phone.jpg" alt="lienhe">
                                       <a href='../Header_footer/tranglienhe.php'>Liên hệ</a>
                                    </div>
                                    <div class="about">
                                       <img src="./image/logo/aboutus.png" alt="about">
                                       <a href="../Header_footer/trangabout.php">About Us</a>
                                    </div>
                                    <div class="new">
                                       <img src="./image/logo/new.png" alt="new">
                                       <a href="../Header_footer/trangtintuc.php">Tin tức</a>
                                    </div>
                                    <div class="giohang">
