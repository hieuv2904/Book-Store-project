...
<body>
    ...
    <div class="container">
        <div class="row">
            <img style="height: 200px" class="image-fluid" src="image/ads2.jpg" alt="ads" />
        </div>
        ...
        <div class="row" style="margin-top: 0; padding: 0; margin-bottom: 16px">
            ...
            <div class="col box rounded-4 gx-4 mx-2">
                <div id="mainProducts" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4" style="margin: 5px">
                    ...
                    $sql = "SELECT DISTINCT Name, Price, Raw_price, Link_img_raw, ID  FROM data_bookstore_v3 ORDER BY ID DESC LIMIT 12 ";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<a href="#"><img  src="' . $image . '" class="card-img-top" alt="' . $name . '" style="height: 100%; object-fit: contain;"></a>';
                            echo '</div>';
